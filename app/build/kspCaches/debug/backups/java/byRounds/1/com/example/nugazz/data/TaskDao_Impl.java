...
public final class TaskDao_Impl implements TaskDao {
  ...
  public TaskDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTask = new EntityInsertionAdapter<Task>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `tasks` (`id`,`title`,`description`,`priority`,`isCompleted`,`dueDate`,`createdAt`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfTask = new EntityDeletionOrUpdateAdapter<Task>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `tasks` SET `id` = ?,`title` = ?,`description` = ?,`priority` = ?,`isCompleted` = ?,`dueDate` = ?,`createdAt` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Object updateCompletionStatus(final int id, final boolean completed,
  ...
  public LiveData<List<Task>> getAllTasks() {
    final String _sql = "SELECT * FROM tasks ORDER BY isCompleted ASC, priority ASC, dueDate ASC, createdAt DESC";
      ...
      public List<Task> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Task(_tmpId,_tmpTitle,_tmpDescription,_tmpPriority,_tmpIsCompleted,_tmpDueDate,_tmpCreatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
